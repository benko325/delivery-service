...
export class MenuItemsController {
    ...
    async findByRestaurant(@Param('restaurantId') restaurantId: string) {
        return this.queryBus.execute(new GetMenuItemsByRestaurantQuery(restaurantId, true));
    }
    ...
    @ApiBearerAuth()
    @ApiOperation({ summary: 'Get all menu items including unavailable (owner/admin)' })
    ...
    async findAllByRestaurant(@Param('restaurantId') restaurantId: string) {
        return this.queryBus.execute(new GetMenuItemsByRestaurantQuery(restaurantId, false));
    }
