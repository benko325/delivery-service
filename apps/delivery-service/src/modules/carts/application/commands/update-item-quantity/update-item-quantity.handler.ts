    ...
    implements ICommandHandler<UpdateItemQuantityCommand>
{
    ...
    async execute(command: UpdateItemQuantityCommand): Promise<{ success: boolean; totalAmount: number }> {
        ...
        cartAggregate.updateItemQuantity(command.menuItemId, command.quantity);
        ...
        return { success: true, totalAmount: cartAggregate.totalAmount };
    }
}
