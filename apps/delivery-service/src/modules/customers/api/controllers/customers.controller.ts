...
import { CreateCustomerDto, UpdateCustomerDto, UpdateAddressDto } from '../dto/customer.dto';
...
export class CustomersController {
    ...
    async update(
        ...
        return this.commandBus.execute(new UpdateCustomerCommand(id, dto.name, dto.phone));
    }
}
