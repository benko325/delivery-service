...
import { IAuthRepository, AuthUser, CreateAuthUserDto } from '../../../core/repositories/auth.repository.interface';
...
export class AuthRepository implements IAuthRepository {
    ...
    private mapToAuthUser(row: unknown): AuthUser {
        ...
        return {
            ...
            roles: (typeof data.roles === 'string' ? JSON.parse(data.roles) : data.roles) as AuthUser['roles'],
