...
export class DriverAggregate extends AggregateRoot {
    ...
    update(name: string, phone: string, vehicleType: string, licensePlate: string): void {
        this._name = name;
        this._phone = phone;
        this._vehicleType = vehicleType;
        this._licensePlate = licensePlate.toUpperCase();
    ...
    updateLocation(latitude: number, longitude: number): void {
        ...
        this.apply(
            new DriverLocationUpdatedEvent(this._id, this._currentLocation, this._updatedAt),
        );
    }
    ...
    completeDelivery(newRating: number): void {
        ...
        this._rating =
            (this._rating * (this._totalDeliveries - 1) + newRating) / this._totalDeliveries;
        this._updatedAt = new Date();
    }
